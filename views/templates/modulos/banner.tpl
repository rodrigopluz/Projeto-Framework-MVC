<div class="lista_registros">
	...
	<!-- START BLOCK : insere_registros -->
		<form name="cadastro_usuario" id="cadastro_usuario" action="?on={on}&in=salvar" enctype="multipart/form-data" onsubmit="return validaCadastro();" method="POST">
			...
			<ul>
				<li>
					<div class="titulo">Novo Banner</div> 
					<div class="dados">
						<div class="dados">
						...
						<div class="dados">
							<label>Banner no tamanho de 727x350 em PNG transparente:</label>
	...
	<!-- START BLOCK : edita_registros -->
		...
		<form name="cadastro_usuario" id="cadastro_usuario" action="?on={on}&in=salvar" enctype="multipart/form-data" onsubmit="return validaCadastro();" method="POST">
			...
			<ul>
				<li>
					<div class="titulo">Editar Banner</div> 
					<div class="dados">
						<label>Nome do Banner:</label>
					...
					<div class="dados">
						<label>Banner no tamanho de 964x532 em PNG transparente:</label>
						<input type="file" name="file" id="file" />
						<br/><br/>
					</div>
						<!-- START BLOCK : foto -->
