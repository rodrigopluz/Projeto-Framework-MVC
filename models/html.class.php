...
class html {
    var $title 		 = TITLE;      	// titulo da pagina
    var $description = DESCRIPTION; // description da pagina
    var $keywords	 = KEYWORDS;    // keywords da pagina
    var $scripts;                   // scripts .js da pagina
    var $styles;                    // estilos .css da pagina
    var $bodyCfg;                   // configuracoes da tag BODY

    var $header;                    // objeto htmlTemplate do header
    var $menu;                      // objeto htmlTemplate do menu
    var $footer;                    // objeto htmlTemplate do footer
    var $body;                      // objeto do corpo da pagina (htmlTemplate)

    var $pageLayout;                // layout do corpo da pagina (arquivo .tpl)

    var $makeCache  = FALSE;        // flag de gravacao de cache da pagina
    var $makeLog    = TRUE;         // flag de gravacao de log
